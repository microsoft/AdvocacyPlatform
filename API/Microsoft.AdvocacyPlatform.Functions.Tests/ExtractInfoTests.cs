...
namespace Microsoft.AdvocacyPlatform.Functions.Tests
{
    ...
    public class ExtractInfoTests
    {
        ...
        public void ExtractInfoHttpTriggerSuccess()
        {
            ...
            Assert.AreEqual(expectedDateInfo.FullDate, response.Data.Date.FullDate);
            Assert.AreEqual(expectedDateInfo.Year, response.Data.Date.Year);
            Assert.AreEqual(expectedDateInfo.Month, response.Data.Date.Month);
            Assert.AreEqual(expectedDateInfo.Day, response.Data.Date.Day);
            Assert.AreEqual(expectedDateInfo.Hour, response.Data.Date.Hour);
            Assert.AreEqual(expectedDateInfo.Minute, response.Data.Date.Minute);
        ...
        public void ExtractInfoHttpTriggerResponseNoEntitiesSuccess()
        {
            ...
            Assert.IsNull(response.Data.Date);
        ...
        public void ExtractInfoHttpTriggerDateTimeOnlyDateBelowThresholdDateRejectedSuccess()
        {
            ...
            Assert.IsNotNull(response.Data.Date);
            Assert.IsNull(response.Data.Date.FullDate, "The full date in the DateInfo object should be null!");
            Assert.AreEqual(0, response.Data.Date.Year, "The year value in the DateInfo object should be 0!");
            Assert.AreEqual(0, response.Data.Date.Month, "The month value in the DateInfo object should be 0!");
            Assert.AreEqual(0, response.Data.Date.Day, "The day value in the DateInfo object should be 0!");
            Assert.AreEqual(0, response.Data.Date.Hour, "The hour value in the DateInfo object should be 0!");
            Assert.AreEqual(0, response.Data.Date.Minute, "The minute value in the DateInfo object should be 0!");
        ...
        /// </summary>
        [TestMethod]
        public void ExtractInfoHttpTriggerDateTimeOnlyTimeSuccess()
        {
            InitializeWithNoDataExtractorMock();
            InitializeSecrets();

...
namespace Microsoft.AdvocacyPlatform.Functions
{
    ...
    /// </summary>
    public static class DeleteAccountRecordingsHttpTrigger
    {
        ...
        /// with the result body respecting the <see cref="Microsoft.AdvocacyPlatform.Contracts.DeleteAccountRecordingsResponse"/> schema.
        /// </returns>
        [FunctionName("DeleteAccountRecordings")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = null)] HttpRequest req,
            ILogger log,
            ExecutionContext context)
        {
            log.LogInformation("DeleteAccountRecordings C# HTTP trigger function processed a request.");

            DeleteAccountRecordingsRequest request = null;
            DeleteAccountRecordingsResponse response = new DeleteAccountRecordingsResponse();
            ...
            try
            {
                ...
                request = FunctionRequestBase.Parse<DeleteAccountRecordingsRequest>(requestBody);
                ...
                response.AreAllRecordingsDeleted = await callWrapper.DeleteAccountRecordingsAsync(log);

                return FunctionHelper.ActionResultFactory<DeleteAccountRecordingsResponse>(false, response);
            }
            catch (MalformedRequestBodyException<DeleteAccountRecordingsErrorCode> ex)
            {
            ...
            return FunctionHelper.ActionResultFactory<DeleteAccountRecordingsResponse>(isBadRequest, response);
        }
    }
}

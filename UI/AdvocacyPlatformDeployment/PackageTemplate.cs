...
namespace AdvocacyPlatformDeployment
{
    using System;
    ...
    {
        /// <summary>
        /// Gets the folder Name for the Package data.
        /// </summary>
        public override string GetImportPackageDataFolderName
        {
            get
            {
                ...
                return "AdvocacyPlatformSolution";
            }
        }

        /// <summary>
        /// Gets the description of the package, used in the package selection UI.
        /// </summary>
        public override string GetImportPackageDescriptionText
        {
            get { return "The Advocacy Platform is a managed solution for automating information discovery tasks for asylum seekers."; }
        }

        /// <summary>
        /// Gets the long name of the Import Package.
        /// </summary>
        public override string GetLongNameOfImport
        {
            get { return "Advocacy Platform"; }
        }
        ...
        /// </summary>
        /// <returns>A value indicating succes.</returns>
        ...
        /// <returns>The record imported.</returns>
